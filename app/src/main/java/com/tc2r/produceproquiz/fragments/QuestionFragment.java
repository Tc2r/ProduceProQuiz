package com.tc2r.produceproquiz.fragments;
...
import com.tc2r.produceproquiz.MainActivity;
import com.tc2r.produceproquiz.OnFragmentInteractionListener;
import com.tc2r.produceproquiz.R;
...
public class QuestionFragment extends Fragment implements View.OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (getArguments() != null) {
			...
			Log.wtf("test", String.valueOf(otherAnswers.size()));
